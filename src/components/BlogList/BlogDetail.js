                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 ftco-animate">
                            <h2 className="mb-3">Is wellness the new luxury</h2>
                            ...
                            <div className="about-author d-flex">
                                <div className="bio align-self-md-center mr-5">
                                    <img src="images/person_2.jpg" alt="Image placeholder" className="img-fluid mb-4" />
                                </div>
                                ...
                                <ul className="comment-list">
                                    <li className="comment">
                                        ...
                                        <div className="comment-body">
                                            <h3>John Doe</h3>
                                            <div className="meta">Sept 25, 2019 at 2:21pm</div>
                                ...
                                <div className="comment-form-wrap pt-5">
                                    ...
                                    <form action="#" className="bg-light p-4">
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control bg-white" id="name" />
                                        </div>
                                        <div className="form-group">
                        ...
                        <div className="col-lg-4 sidebar ftco-animate">
                            ...
                            <div className="sidebar-box ftco-animate">
                                <h3 className="heading-2">Recent Blog</h3>
                                <div className="block-21 mb-4 d-flex">
                                    ...
                                    <div className="text">
                                        ...
                                        <div className="meta">
                                            <div><a href="#"><span className="icon-calendar" /> Sept. 25, 2019</a></div>
                            ...
                            <div className="sidebar-box ftco-animate">
                                <h3 className="heading-2">Tag Cloud</h3>
                                <div className="tagcloud">
                            ...
                            <div className="sidebar-box ftco-animate">
                                <h3 className="heading-2">Paragraph</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus itaque, autem necessitatibus voluptate quod mollitia delectus aut, sunt placeat nam vero culpa sapiente consectetur similique, inventore eos fugit cupiditate numquam!</p>
                            </div>
                        </div>
                    </div>
